...
HELPFUL: Angular v22までは、Angularは6か月ごとのメジャーリリースサイクルで、各メジャーリリースに対して1～3回のマイナーリリースがありました
...
すべてのメジャーリリースは通常、24か月間サポートされます。

| サポートステージ      | サポートタイミング | 詳細                                                                    |
| :-------------------- | :----------------- | :---------------------------------------------------------------------- |
| アクティブ            | 12か月             | 定期的にスケジュールされた更新とパッチがリリースされます                |
...
AngularチームがAPIや機能を削除する場合は、_非推奨_ とマークされます。これは、APIが陳腐化している、別のAPIに置き換えられている、またはその他の理由で廃止されている場合に発生します。非推奨のAPIは、非推奨フェーズの間は使用できます。非推奨フェーズは、少なくとも1つのメジャーバージョン（約1年）続きます。
...
| 非推奨期間       | APIや機能が非推奨になると、少なくとも次の1つのメジャーリリース（少なくとも12か月間）は引き続き存在します。その後、非推奨のAPIと機能は削除の対象となります。非推奨はどのリリースでも発表できますが、非推奨のAPIや機能の削除は、メジャーリリースでのみ行われます。非推奨のAPIや機能が削除されるまでは、LTSサポートポリシーに従って維持されます。つまり、重要な問題とセキュリティ問題のみが修正されます。                                             |
